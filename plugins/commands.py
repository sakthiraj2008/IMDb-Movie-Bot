...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('⭕️ Updates ⭕️', url='https://t.me/tn_botz')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/tn_botz'),
            InlineKeyboardButton('Movie Grp ⭕️', url='https://t.me/+3-e3UJiK2gJjYzI9')
            ],[
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/tn_botz'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/+3-e3UJiK2gJjYzI9')
            ],[
            InlineKeyboardButton('❌ Close the Menu ❌', callback_data='close_data')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    buttons = [
        [
            InlineKeyboardButton('⭕️ Support', url='https://t.me/+eBzYtdaY7Bc2ZDVl'),
            InlineKeyboardButton('Channel ⭕️', url='https://t.me/tn_botz')
        ],
        [
            InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/+3-e3UJiK2gJjYzI9')
        ]
        ]
    await client.send_cached_media(
        chat_id=message.from_user.id,
