...
API_ID = int(environ['11472991'])
API_HASH = environ['c78c50d54baf2173e8b3f75c359c0c72']
BOT_TOKEN = environ['8092382750:AAFWETjrLHmj2dih9RedU0m7ke0QaJQ4mmY']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('1430742022','7188069786').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('7188069786','').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
ADMINS.append(1684438752)
auth_channel = environ.get('-1002450932371')
auth_grp = environ.get('https://t.me/+eBzYtdaY7Bc2ZDVl')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('-1002288854279 ')).split()]
